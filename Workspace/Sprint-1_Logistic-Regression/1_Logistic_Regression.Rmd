...
selected_variables <- names(coef(caret_both$finalModel))
selected_variables <- selected_variables[c(-1, -2)]
correlation_matrix <- cor(select(diabetic_data2,selected_variables))
...
#it still has some correlated columns
